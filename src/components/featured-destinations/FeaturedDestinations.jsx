...
const FeaturedDestinations = () => {
  ...
  const searchValue = searchParams.get('search') || ''; // ?search=beach
      ...
      <section className="mb-12 mx-6 lg:mx-28 my-4 lg:my-16">
        ...
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          ...
          <button
            ...
            className="mt-4 bg-[#4F46E5] text-white px-4 py-2 rounded-lg hover:bg-blue-600"
          >
            Try Again
          </button>
        </div>
        ...
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          {searchValue ? (
            <p className="text-gray-500">
              No such package found: <span className="font-semibold">{searchValue}</span>
            </p>
          ) : (
