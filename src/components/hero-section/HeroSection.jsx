            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border-none rounded focus:ring-2 focus:ring-primary focus:outline-none"
                />
              </div>
              ...
              <button className="bg-primary text-white px-8 py-3 rounded font-medium hover:bg-opacity-90 transition whitespace-nowrap">
                <i className="ri-search-line mr-2" /> Search
              </button>
            </div>
          </div>
